...
function fetchAppointments() {
  ...
  $.ajax({
    ...
    success: function(debug) {
      ...
      console.log('Consultant ID found:', debug.consultant_lookup?.found);
      console.log('Consultant ID:', debug.consultant_lookup?.consultant_id);
      console.log('Total appointments in DB:', debug.total_appointments);
